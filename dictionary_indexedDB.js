...
app.indexedDB.open = function () {
    ...
    openRequest.onupgradeneeded = function (e) {
        try {
            ...
            store.createIndex("motion", "motion", { unique: false, autoIncrement: true });
...
app.indexedDB.createList = function () {
    ...
    cursorRequest.onsuccess = function (e) {
        ...
        td2.innerHTML = val.category;
        tr.appendChild(td2);
        var td3 = document.createElement("td3");
        td3.innerHTML = val.handshape;
        tr.appendChild(td3);     
...
app.indexedDB.getWord = function (WORD) {
    ...
    openRequest.onsuccess = function (e) {
        ...
        var wordHandshape = document.getElementById("wordHandshape");
        var wordPosition = document.getElementById("wordPosition");
        var wordMotion = document.getElementById("wordMotion");
        ...
        for (i = wordName.childNodes.length - 1; i >= 0; i--) {
            ...
            wordHandshape.removeChild(wordHandshape.childNodes[i]);
            wordPosition.removeChild(wordPosition.childNodes[i]);
            wordMotion.removeChild(wordMotion.childNodes[i]);
        ...
        cursorRequest.onsuccess = function () {
            ...
            var whandshape = document.createElement("whandshape");
            var wposition = document.createElement("wposition");
            var wmotion = document.createElement("wmotion");
            ...
            whandshape.innerHTML = result.handshape;
            wposition.innerHTML = result.position;
            wmotion.innerHTML = result.motion;
            ...
            wordHandshape.appendChild(whandshape);
            wordPosition.appendChild(wposition);
